...
# Overall time of the MP4 file
overall_time = datetime.timedelta(hours=1, minutes=35, seconds=00)

# Duration of each part
part_duration = datetime.timedelta(hours=0, minutes=2, seconds=0)

# Open the MP4 file
video = VideoFileClip("/home/rajashekar/Music/main/videoplayback.mp4")
...
for i in range(num_parts):
    ...
    wav_filename = f"/home/rajashekar/Music/main/parts2/part_{i + 1}_{start_time_str}.wav"
    subclip = video.subclip(start_seconds, end_seconds)
    subclip.audio.write_audiofile(wav_filename, codec='pcm_s16le', fps=sample_rate)
